    ...
    class Day1
    {
        public static void Part1()
        {
            ...
            foreach (int a in input)
            {
                ...
                {
                    if (countera == counterb) { counterb++; continue; }
                    if (a + b == 2020)
                    {
        ...
        public static void Part2()
        {
            ...
            foreach (int a in input)
            {
                foreach (int b in input)
                {
                    ...
                    {
                        if (countera == counterb || counterb == counterc || countera == counterc) { counterc++; continue; }
                        if (a + b + c == 2020)
                        {
